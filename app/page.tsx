...
export default function Home() {
  ...
  // Get featured articles (first 3 published articles)
  const featuredArticles = publishedArticles.slice(0, 3)

  // Get recent articles (next 6 published articles)
  const recentArticles = publishedArticles.slice(3, 9)
      ...
      <header className="container mx-auto py-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm">
            <Link href="/" className="text-white transition-colors border-b-2 border-purple-500 pb-1">
              Home
            </Link>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-center gap-2">
                  ...
                  <span>Brianmanoti254@gmail.com</span>
                </li>
              </ul>
            </div>
          </div>
